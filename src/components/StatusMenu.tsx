	...
	return (
		<div className="relative" ref={menuRef}>
			<button
				...
				className={`w-[18ch] flex items-center justify-between px-3 py-1 text-sm font-bold text-[.85em] rounded border-2 ${currentStyle.backgroundColor} ${currentStyle.textColor} ${currentStyle.borderColor}`}
			>
